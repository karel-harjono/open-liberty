...
public class AuthenticatorTest {
    ...
    private static final HttpServletRequest request = mockery.mock(HttpServletRequest.class); //v5 update
        ...
        mockery.checking(new Expectations() {
            {
                ...
                atMost(3).of(authHelper).loginWithUserName(with(any(javax.servlet.http.HttpServletRequest.class)),
                                                           with(any(javax.servlet.http.HttpServletResponse.class)),
                ...
                atMost(3).of(response).addCookie(with(any(javax.servlet.http.Cookie.class)));
